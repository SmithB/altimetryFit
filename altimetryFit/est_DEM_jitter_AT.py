...
def get_residuals(DEM_file):
    ...
    try:
        ...
        thecmd=f'register_WV_DEM_with_IS2.py --DEM_file {meta_file} --GeoIndex_wc "/Volumes/ice1/ben/ATL06/tiles/Antarctic/005/c*/GeoIndex.h5" -m /home/ben/git_repos/ATL1415/masks/Antarctic/Greene_22_shelf_plus_10m_mask_240m.tif --DEBUG'
        os.system(thecmd)
        D=pc.data().from_h5(meta_file, group='data')
    return D
...
def main():
    ...
    parser.add_agrument('--url_list_file','-u', type=str, help='File containing the PGC url for each DEM filename')
    parser.add_argument('--rms_grad', type=float, default=1.e-5, help='Expected RMS gradient of the bias')
    parser.add_argument('--rms_bias', type=float, default=2, help='Expected RMS of the bias')
    ...
    out_precision={'R0': 1.e-3,
                   ...
                   'N_data': 1.}
    out={}
    for field, precision in out_precision.values():
